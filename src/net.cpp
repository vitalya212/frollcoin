...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Frollcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"frollcointools.com", "dnsseed.frollcointools.com"},
    {"frollcoinpool.org", "dnsseed.frollcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"frollcointools.com", "testnet-seed.frollcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Frollcoin is probably already running."), addrBind.ToString().c_str());
        else
